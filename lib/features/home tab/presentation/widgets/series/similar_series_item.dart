...
class SimilarSeriesItem extends StatelessWidget {
  final SeriesResults movie;

  const SimilarSeriesItem(this.movie, {super.key});
                ...
                SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: Column(children: [
                      ...
                      const VerticalSpace(1),
                      Text(
                          movie.firstAirDate ?? //substring here, causes error in some movies
                              "".substring(0, 4),
                          style: verySmallText),
                    ]),
                  ),
